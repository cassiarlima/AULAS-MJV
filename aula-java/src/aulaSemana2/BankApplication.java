...
public class BankApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("----------------------------------------------------------------------");
		System.out.println("Alberto, após a transferência para a conta da Tamilles, seu saldo é de R$"
				+ contaDoAlberto.getSaldo());

		contaDoGrupo3.depositar(contaDaTamilles, 1000.00);
		contaDoGrupo3.sacar(contaDaTamilles, 1500.00);
		System.out.println("----------------------------------------------------------------------");
		System.out.println(
				"Tamilles, você não tem esse valor disponível, seu saldo é de: R$" + contaDaTamilles.getSaldo());
		System.out.print("----------------------------------------------------------------------");
